...
const rows = [
  createData("Gruppo1", "Descrizione gruppo 1",""),
  createData("Gruppo2", "Descrizione gruppo 2",""),
  createData("Gruppo3", "Descrizione gruppo 3",""),
  createData("Gruppo4", "Descrizione gruppo 4",""),
  createData("Gruppo5", "Descrizione gruppo 5",""),
];
