...
CREATE TABLE `LINEE` (
  ...
  `IP_LINEA` varchar(39) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `PORTA` int NOT NULL,
...
CREATE TABLE `UTENZE` (
  ...
  `COGNOME` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `AZIENDA` varchar(70) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
