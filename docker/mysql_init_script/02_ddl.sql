...
CREATE TABLE `TEST_GENERATORE_CARICATO` (
  ...
  `PATH_INSTANCE` varchar(4096) NULL,
...
CHANGE `SCOPE` `SCOPE` enum('TEMPLATE','TEST','TEST_CARICATO','LINEA_GENERATORE','TESTGEN_CARICATO') COLLATE 'utf8_general_ci' NOT NULL AFTER `VERSION`;
