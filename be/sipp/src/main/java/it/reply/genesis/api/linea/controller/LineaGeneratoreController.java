...
import it.reply.genesis.api.linea.payload.LineaGeneratoreAddRequest;
import it.reply.genesis.api.linea.payload.LineaGeneratoreAddResponse;
import it.reply.genesis.api.linea.payload.LineaGeneratoreDTO;
import it.reply.genesis.api.linea.payload.LineaGeneratoreListResponse;
import it.reply.genesis.api.linea.payload.LineaGeneratoreRemoveRequest;
import it.reply.genesis.api.linea.payload.LineaGeneratoreRetrieveResponse;
import it.reply.genesis.api.linea.payload.LineaGeneratoreUpdateRequest;
import it.reply.genesis.api.linea.payload.LineaGeneratoreUpdateResponse;
