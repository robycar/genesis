...
import it.reply.sipp.api.test.payload.TestCaseAddRequest;
import it.reply.sipp.api.test.payload.TestCaseAddResponse;
import it.reply.sipp.api.test.payload.TestCaseDTO;
import it.reply.sipp.api.test.payload.TestCaseListResponse;
import it.reply.sipp.api.test.payload.TestCaseRemoveRequest;
import it.reply.sipp.api.test.payload.TestCaseRetrieveResponse;
import it.reply.sipp.api.test.payload.TestCaseUpdateRequest;
import it.reply.sipp.api.test.payload.TestCaseUpdateResponse;
